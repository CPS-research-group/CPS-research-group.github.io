...
![image-right](/assets/graphics/descartes.png){:height="40%" width="40%"}{: .align-left}
...
![image-right](/assets/graphics/mlsafety.png){:height="30%" width="30%"}{: .align-left}
...
![image-right](/assets/graphics/controlHeating.png){:height="30%" width="30%"}{: .align-right}
...
![image-left](/assets/graphics/cpsModellingLogo.png){:height="30%" width="30%"}{: .align-left}
...
![image-left](/assets/graphics/resilienceLogo.png){:height="30%" width="30%"}{: .align-right}
...
![image-right](/assets/graphics/time2task.png){:height="30%" width="30%"}{: .align-left}
...
![image-right](/assets/graphics/Cache2Predict.png){:height="30%" width="30%"}{: .align-right}
